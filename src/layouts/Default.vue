    ...
    <header class="border-green-700 border-t-14">
      <nav class="container flex flex-wrap items-center justify-between py-8 mx-auto">
        ...
        <div class="block lg:hidden">
          <button @click="toggle" class="flex items-center px-3 py-2 border border-gray-500 rounded hover:text-gray-600 hover:border-gray-600" data-cypress="hamburger">
        ...
        <ul
          class="items-center flex-grow block w-full mt-8 space-y-6 font-bold tracking-wide uppercase lg:space-x-8 lg:space-y-0 lg:flex lg:flex-initial lg:w-auto lg:mt-0"
    ...
    <footer class="text-white bg-green-700">
      <div class="container flex flex-col items-center justify-between py-8 mx-auto lg:flex-row">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:favourmaxoti@outlook.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/maximof" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/maximsnide" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/max_kellian" target="_blank" class="text-white hover:text-gray-400">
